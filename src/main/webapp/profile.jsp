...
<div class="footer-row last-content-row">
 ...
 <div class="footer-bottom">
    <div class="footer-column">
        <p style="white-space: nowrap;">&copy; 2024 Apex Academic Centre | Developed by <a href="https://esihleconnections.co.za/" class="footer-link">eSihleConnections</a> All rights reserved.</p>
    </div>
    <div class="footer-column">
